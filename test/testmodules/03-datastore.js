...
//
// Datastore - ILibSimpleDataStore (Put/PutCompressed/Get/Delete/Compact/Keys), deliberately
// using key lengths that collide under ILibHashtable_DefaultHashFunc (see meshagent-todo.md #0).
//
...
exports.run = function (check, deepEqual, done) {
    ...
    // Key lengths sweep 4-16 chars, deliberately in the range where
    // ILibHashtable_DefaultHashFunc only hashes the last 4 bytes (5-12) - see meshagent-todo.md #0.
    ...
    function isDeleted(i) { return (i % 11) == 3; } // rotating subset
