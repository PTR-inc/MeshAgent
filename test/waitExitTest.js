// waitExit() test. Covers nesting, the timeout that throws, the wait forever escapes, two waits on one child, promise.wait() and the depth cap.
...
// 9) Nest 16 deep. The 17th nested wait must throw and the loop must survive.
