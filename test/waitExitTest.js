...
// the review fixes of 2026-09-17 (detached child, closed stdio, stopped child, retried wait after process.exit(), wait from an ended wait's last pass,
...
try
{
    hung.waitExit(500);            // Without an argument the wait has no deadline. Only an explicit timeout throws.
}
catch (e)
{
